...
class PlayerquizzController extends AbstractController
{
    ...
    public function quizz(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $quizzRepository = $this->getDoctrine()->getRepository(Playerquizz::class);
    ...
    {
        $quizzRepository = $this->getDoctrine()->getRepository(Playerquizz::class);
        return $this->render('playerquizz/history.html.twig', [
    ...
    public function quizzQuestion(
        ...
        return $this->render(
            'playerquizz/quizzquestion.html.twig',
            [
                'quizz' => $quizz,
                'question' => $question,
                'questions' => $questions,
    ...
    public function quizzAnswer(
        ...
        return $this->render(
            'playerquizz/quizzanswer.html.twig',
            [
                'quizz' => $quizz,
                'questions' => $questions,
                'playeranswer' => $playeranswer,
     ...
     */
    public function quizzSettings(Playerquizz $quizz, Request $request)
    {
        $form = $this->createFormBuilder($quizz)
        ...
        return $this->render(
            'playerquizz/settings.html.twig',
            [
                'form' => $form->createView(),
                'quizz' => $quizz
            ]
     ...
     */
    public function quizzNextQuestion(Playerquizz $quizz)
    {
        ...
        if (count($arrayQuestion2ask) > 0) {
            ...
            return $this->render(
                'playerquizz/endofquizz.html.twig',
                [
                    'quizz' => $quizz
                ]
            );
