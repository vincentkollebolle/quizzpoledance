...
{
    /*
    * Scénario : on peut afficher la page pour être prévenu de la sortie du quizz
    ...
    */
    public function testPrintSubscribePage()
    {
        ...
        //and: Un titre h1 contenant le mot quizz apparait 
        $this->assertSelectorTextContains('html', 'Pole Dance Playerquizz');

        //and: on lui propose un formulaire pour ajouter son mail
        $this->assertCount(1, $crawler->selectButton('Démarrer le Playerquizz'));
    }
