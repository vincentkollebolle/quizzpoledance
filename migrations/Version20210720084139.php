 ...
 */
final class Version20210720084139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quizz ADD difficulty VARCHAR(255) NOT NULL, CHANGE date date DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quizz DROP difficulty, CHANGE date date DATETIME DEFAULT \'NULL\'');
    }
}
